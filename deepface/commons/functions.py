...
######################### by usman
# it tell if the is present or not
def detect_face2(img_url ): # usman: set enforce detecion to false
...
def detect_face(img, detector_backend = 'opencv', grayscale = False, enforce_detection = False, align = True): # usman: set enforce detecion to false
